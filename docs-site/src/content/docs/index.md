---
title: Провайдер Yandex Smart Home
description: Документация провайдера Yandex Smart Home для Music Assistant
---

<img src="https://raw.githubusercontent.com/trudenboy/ma-provider-yandex-smarthome/dev/provider/icon.svg" alt="Yandex Smart Home" style="width: 72px; float: right; margin: 0 0 1rem 1.5rem;" />


> Яндекс Умный Дом plugin for Music Assistant — управление MA-плеерами через Smart Home API и Алису
...
[![License](https://img.shields.io/github/license/trudenboy/ma-provider-yandex-smarthome)](https://github.com/trudenboy/ma-provider-yandex-smarthome/blob/dev/LICENSE)
...
Music Assistant поддерживает [Yandex Smart Home](https://yandex.ru/dev/dialogs/smart-home/) — плеер.
