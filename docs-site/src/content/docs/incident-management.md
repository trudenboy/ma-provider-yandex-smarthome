...
# Yandex Smart Home — Управление инцидентами

## Куда заводить инциденты

> **Заводи задачи здесь:** [github.com/trudenboy/ma-provider-yandex-smarthome/issues](https://github.com/trudenboy/ma-provider-yandex-smarthome/issues)
...
- **Поле Provider**: устанавливается автоматически для Yandex Smart Home
