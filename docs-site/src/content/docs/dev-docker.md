...
# Yandex Smart Home — локальная разработка через Docker

Запусти полноценный Music Assistant с провайдером Yandex Smart Home одной командой —
...
## Подключение провайдера Yandex Smart Home

После входа:

1. Перейди в **Settings** → **Providers**
2. Найди **Yandex Smart Home** в списке — он уже доступен, код загружен автоматически
