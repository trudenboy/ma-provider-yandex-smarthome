...
provider (someone editing `music_assistant/providers/yandex_smarthome/` directly in
...
`music_assistant/providers/yandex_smarthome` upstream eventually — that is the
