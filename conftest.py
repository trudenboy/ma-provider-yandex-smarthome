"""Root conftest: ensure provider/ is importable as music_assistant.providers.yandex_smarthome."""
...
# Make the provider/ directory importable as music_assistant.providers.yandex_smarthome
